...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("˹ ᴄσηᴛᴧᴄᴛ ˼", url="https://t.me/LEGEND_MICKEY")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("˹ sυᴘᴘσʀᴛ ˼", url="https://t.me/ZOYU_SUPPORT"),
            InlineKeyboardButton("˹ υᴘᴅᴧᴛєs ˼", url="https://t.me/THE_INCRICIBLE"),
        ],
        [
